...
const Image =
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNQursqsAFp0EWMoWzrZ6u_V02GuFYhC3p2Q&usqp=CAU";
const BrandsSlider = () => {
  ...
  return (
    <div className='Brands'>
      <div className='Brands-Top'>
        <h1 className='Brands-Top-Name'>Brands</h1>
        <div className='Brands-Top-Img'>
          <svg
            className='prev Brands-Top-Img-Left'
          ...
          <svg
            className='next Brands-Top-Img-Left'
            xmlns='http://www.w3.org/2000/svg'
            width='31'
            height='20'
            viewBox='0 0 31 20'>
      ...
      <Swiper
        ...
        <SwiperSlide>
          <img className='Brands-ImgMain' src={Image} alt='' />
        </SwiperSlide>
        <SwiperSlide>
          <img className='Brands-ImgMain' src={Image} alt='' />
        </SwiperSlide>
