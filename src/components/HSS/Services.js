  ...
  return (
    <div className='HSS'>
      <div className='HSS-Top'>
        <h1 className='HSS-Top-Title'>Home Healthcare Services</h1>
        <div className='HSS-Top-Img'>
          <button className='HSS-Top-Img-Left'>
            <svg
              className='prev'
          ...
          <button className='next HSS-Top-Img-Right'>
            <svg
              className=''
              xmlns='http://www.w3.org/2000/svg'
              width='31'
