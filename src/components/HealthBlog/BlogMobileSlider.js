...
const BlogSlider = () => {
  ...
  return (
    <div className='HealthBlog'>
      <div className='HealthBlog-Top'>
        <h1 className='HealthBlog-Top-LeftName'>Health Blog</h1>
        <div className='HealthBlog-Top-RightContainer'>
          <h1 className='HealthBlog-Top-RightContainer-ViewAll'>ViewAll</h1>
          <div className='HealthBlog-Top-RightContainer-Arrow'>
            <svg
              className='Blogprev HealthBlog-Top-RightContainer-Arrow-ArrowLeft'
            ...
            <svg
              className='Blogprev HealthBlog-Top-RightContainer-Arrow-ArrowRight'
              xmlns='http://www.w3.org/2000/svg'
              width='31'
              height='20'
              viewBox='0 0 31 20'>
